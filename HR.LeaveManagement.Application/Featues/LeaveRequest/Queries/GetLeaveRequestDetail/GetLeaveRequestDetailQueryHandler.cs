...
{
	public class GetLeaveRequestDetailQueryHandler : IRequestHandler<GetLeaveRequestDetailQueryRequest, LeaveRequestDetailsDto>
	{
		...
		public async Task<LeaveRequestDetailsDto> Handle(GetLeaveRequestDetailQueryRequest request, CancellationToken cancellationToken)
		{
