...
namespace HR.LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20231203214922_InitialMigration")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveRequest", b =>
                {
                    ...
                    b.Property<string>("RequestionEmployeeId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 12, 3, 23, 49, 22, 285, DateTimeKind.Local).AddTicks(3347),
                            DateModified = new DateTime(2023, 12, 3, 23, 49, 22, 285, DateTimeKind.Local).AddTicks(3394),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
